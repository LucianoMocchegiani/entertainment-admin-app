...
const UploadFileComponent = ({id, path, data}) => {
    ...
    return(
       <> 
            ...
            {activeUpload?<ProgressBar id={id} setActive={setActiveUpload} file={selectedFile} serverpatch={path} serieData={data} movieData={null}/>:null}
        </>
    )
}
